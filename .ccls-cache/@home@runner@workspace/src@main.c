...
void compare_sentences(const char* sentence1, const char* sentence2, char target) {
    /* Нахождение последнего вхождения буквы target */
...
int main() {
    ...
    printf("=== Пример 1 ===\n");
    compare_sentences(sentence1, sentence2, 'ш');
    
    printf("\n=== Пример 2 ===\n");
    char sentence3[] = "Машина едет по шоссе.";
    char sentence4[] = "Школьник идет в школу.";
    compare_sentences(sentence3, sentence4, 'ш');
